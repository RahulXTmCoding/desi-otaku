...
2.  You need to add the following secrets to your GitHub repository (**Settings -> Secrets and variables -> Actions**):
    ...
    -   **For Application Environment Variables (to be synced to Key Vault)**:
        -   `DATABASE`
        -   `SECRET`
        -   `CLIENT_URL`
        -   `RAZORPAY_KEY_ID`
