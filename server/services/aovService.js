  ...
  static async initializeAOVSettings() {
    try {
      ...
      await Settings.setSetting('quantity_discounts', {
        enabled: true,
        tiers: [
          { minQuantity: 2, discount: 5, label: '5% off on 2+ items' },
          { minQuantity: 3, discount: 15, label: '15% off on 3-4 items' },
          { minQuantity: 5, discount: 20, label: '20% off on 5+ items' }
        ]
      ...
      await Settings.setSetting('loyalty_multipliers', {
        ...
        multipliers: [
          { minAmount: 1500, multiplier: 2, label: '2X points on orders ₹1500+' },
