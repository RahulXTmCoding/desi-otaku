    ...
    <>
      ...
      >
        <button className="flex items-center gap-1 relative transition-all group" style={{ color: 'var(--color-text)', opacity: 0.9 }}>
          <span className="relative z-10">SHOP BY PRODUCTS</span>
        ...
        <div className={`absolute top-full left-0 mt-2 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 transition-all duration-300 z-50 ${
      ...
      >
        <button className="flex items-center gap-1 relative transition-all group" style={{ color: 'var(--color-text)', opacity: 0.9 }}>
          <span className="relative z-10">SHOP BY ANIME</span>
