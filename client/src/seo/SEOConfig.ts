...
// Use brand config for BASE_URL - centralized configuration
export const BASE_URL = brandConfig.baseUrl;
...
export const DEFAULT_SEO = {
  ...
  defaultKeywords: [
    ...brandConfig.seo.defaultKeywords,
    "premium fashion india",
    "contemporary streetwear",
    "designer apparel india",
  ],
  defaultOgImage: brandConfig.ogImagePath,
  twitterHandle: brandConfig.socialHandles.twitter || "@attars_club",
  facebookAppId: brandConfig.seo.facebookAppId || "",
};
...
export const CATEGORY_SEO_TEMPLATES = {
  tshirts: {
    ...
    description:
      "Shop premium t-shirts at Attars Club. Browse Attars Fashion collection - anime merchandise, Indian culture designs, TV show apparel. Attars Clothing delivers premium quality across India.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  hoodies: {
    ...
    description:
      "Shop premium hoodies at Attars Club. Explore Attars Fashion hoodie collection - anime hoodies, streetwear designs, Indian culture prints. Attars Clothing delivers contemporary sweatshirts across India.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  oversized: {
    ...
    description:
      "Shop oversized streetwear at Attars Club. Discover Attars Fashion oversized collection - loose fit t-shirts, hoodies, anime designs. Attars Clothing offers comfortable luxury fashion across India.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  anime: {
    ...
    description:
      "Shop premium anime merchandise at Attars Club. Browse Attars Fashion anime collection - authentic anime t-shirts, hoodies, and streetwear. Attars Clothing delivers high-quality anime apparel across India.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  "indian-culture": {
    ...
    description:
      "Shop Indian culture apparel at Attars Club. Explore Attars Fashion heritage collection - cultural streetwear, traditional modern designs. Attars Clothing celebrates Indian culture with premium fashion.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  "tv-shows": {
    ...
    description:
      "Shop TV show merchandise at Attars Club. Browse Attars Fashion pop culture collection - series-inspired designs, entertainment fashion. Attars Clothing delivers premium pop culture apparel across India.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  jeans: {
    ...
    description:
      "Shop premium jeans at Attars Club. Discover Attars Fashion denim collection - designer jeans, luxury fit, contemporary styles. Attars Clothing delivers premium quality jeans across India.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  shirts: {
    ...
    description:
      "Shop designer shirts at Attars Club. Browse Attars Fashion shirt collection - premium formal and casual shirts, luxury fabrics. Attars Clothing delivers contemporary designs for modern India.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
...
export const PAGE_SEO_DATA: Record<string, SEOPageData> = {
  home: {
    ...
    description:
      "Attars Club - Premium fashion destination in India. Shop at Attars for exclusive streetwear, anime designs, and luxury apparel. Attars Fashion brings you the best in contemporary style with fast delivery across India.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
    ...
    structuredData: {
      ...
      url: BASE_URL,
      description:
        "Premium fashion brand offering designer t-shirts, hoodies, oversized clothing and luxury apparel across India",
      areaServed: "IN",
      potentialAction: {
        "@type": "SearchAction",
        target: {
  ...
  shop: {
    ...
    description:
      "Shop at Attars Club for premium fashion India. Browse Attars Fashion collection - designer t-shirts, hoodies, oversized clothing & luxury apparel. Attars Clothing delivers across India with express shipping.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  product: {
    ...
    description:
      "Buy {productName} at Attars Club - premium fashion item from Attars Fashion collection. Superior quality from Attars Clothing, available in multiple colors & sizes. Express shipping across India.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  customize: {
    ...
    description:
      "Design custom fashion at Attars Club. Create your own Attars Fashion pieces with our design studio. Attars Clothing offers personalized premium apparel with quality guaranteed across India.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  about: {
    ...
    description:
      "About Attars Club - premium fashion brand India. Learn about Attars Fashion journey, Attars Clothing quality commitment, and our mission to deliver exceptional designer apparel across India.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  contact: {
    ...
    description:
      "Contact Attars Club for orders, support, and inquiries. Reach Attars Fashion team for custom designs and bulk orders. Attars Clothing customer service across India.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  "size-guide": {
    ...
    description:
      "Attars size guide for perfect fit. Find your size for Attars Fashion t-shirts, hoodies, and apparel. Attars Clothing size chart with measurements for all products.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  "shipping-policy": {
    ...
    description:
      "Attars Club shipping policy for India. Learn about Attars Fashion delivery options, Attars Clothing shipping times, and express delivery across India.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  "return-policy": {
    ...
    description:
      "Attars Club return policy for easy returns and exchanges. Return Attars Fashion items hassle-free. Attars Clothing return process for customer satisfaction.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  "cancellation-policy": {
    ...
    description:
      "Attars Club cancellation policy for order changes. Cancel Attars Fashion orders easily. Attars Clothing cancellation process and refund policy.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  "terms-of-service": {
    ...
    description:
      "Attars Club terms of service and conditions. Legal terms for shopping at Attars Fashion. Attars Clothing terms and conditions for India customers.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
  ...
  "privacy-policy": {
    ...
    description:
      "Attars Club privacy policy for customer data protection. How Attars Fashion protects your privacy. Attars Clothing data security and privacy commitment.",
    keywords: [
      "attars",
      "attars club",
      "attars fashion",
...
export const ORGANIZATION_STRUCTURED_DATA = {
  ...
  description:
    "Premium fashion store offering designer apparel, contemporary clothing, and curated fashion pieces",
  sameAs: [
...
export const AI_PLATFORM_DATA = {
  brand: {
    name: "Attars Clothing",
    description:
      "Premium fashion brand specializing in designer apparel across India",
    categories: [
      "t-shirts",
      "hoodies",
      "oversized-clothing",
...
export const getCategoryStructuredData = (
  categoryName: string,
  products: any[],
) => ({
  "@context": "https://schema.org",
...
export const getEnhancedProductStructuredData = (
  ...
  description:
    product.description ||
    `Premium ${category || "fashion"} item from Attars Clothing India. Designer quality with luxury materials and contemporary design.`,
  image: product.images || [],
  sku: product._id,
