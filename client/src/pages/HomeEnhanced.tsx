            ...
            <div className="relative">
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-4">
                  <div className="bg-gradient-to-tr from-pink-500 via-red-500 to-yellow-500 rounded-2xl p-6 transform -rotate-6 hover:rotate-0 transition-transform shadow-2xl hover:shadow-3xl border-2 border-gradient-to-r from-pink-400 to-yellow-400">
                    <img src="https://lh3.googleusercontent.com/pw/AP1GczM-g5B7K3QvkbQ7riB-9DXBkvNKIPf_4rFjIggOpYbQLTnj89FQBLF7ciAc2uRpyTjXjVAjXDg541yKe3Y2Khf4e3yGa44029C6RP5WuE5nGJGMy51_RbUT1wf7ZPdU3acNoRW4UY4Kh2fLm458GFDH=w680-h945-s-no-gm?authuser=0" alt="Anime Tee 1" className="rounded-lg border-2 border-white/20" />
                  </div>
                </div>
                <div className="space-y-4 pt-8">
                  <div className="bg-gradient-to-bl from-indigo-600 via-purple-600 to-cyan-400 rounded-2xl p-6 transform rotate-3 hover:rotate-0 transition-transform shadow-2xl hover:shadow-3xl border-2 border-gradient-to-r from-indigo-400 to-cyan-400">
                ...
                <div className="space-y-4">
                  <div className="bg-gradient-to-tl from-emerald-500 via-lime-400 to-orange-400 rounded-2xl p-6 transform rotate-6 hover:rotate-0 transition-transform shadow-2xl hover:shadow-3xl border-2 border-gradient-to-r from-emerald-400 to-orange-400">
                    <img src="https://lh3.googleusercontent.com/pw/AP1GczNgWXvNBxyGFElB0fURWK6kkPJh7aBkdXcADmOqB_4BMzy9nt8rlsz1OSP8-ovFriAmmR04Z6QA11caWhELwUAZgZ6W1ussfzLchr_KcWVsR1jqtJ2VGBQ1vZxKvFhqGWI-VbPn4OWVe4kKN-ib3tb0=w751-h945-s-no-gm?authuser=0" alt="Anime Tee 3" className="rounded-lg border-2 border-white/20" />
                  </div>
                </div>
              </div>
            </div>
