            ...
            <div className="relative">
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-4">
                  <div className="bg-gradient-to-tr from-pink-500 via-red-500 to-yellow-500 rounded-2xl p-1 sm:p-2 lg:p-6 transform -rotate-6 hover:rotate-0 transition-transform shadow-2xl hover:shadow-3xl border-2 border-gradient-to-r from-pink-400 to-yellow-400">
